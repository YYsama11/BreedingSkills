...
- `skills/resequencing-skill`：原始 FASTQ 质控、过滤与比对
- `skills/variant-calling-skill`：变异检测、标准化与过滤
- `skills/emmax-prep-skill`：EMMAX 输入、协变量与 kinship 准备
- `skills/gwas-skill`：EMMAX 关联分析与结果整理
- `skills/qtl-skill`：QTL 解释与候选基因提取
...
- `--skills resequencing-skill,gwas-skill`：只安装指定 skill
